...
This repo is a production-ready e-commerce site for an Indian healthy-food D2C
business. The owner sells snacks, beverages, and superfoods. The site has a
public storefront, customer accounts, Razorpay checkout, and a built-in admin
dashboard so the owner can manage everything without ever touching SQL.
